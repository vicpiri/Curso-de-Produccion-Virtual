const homeView = document.getElementById('home-view');
    ...
    async function showTalk(id) {
        ...
        const day = id.startsWith('charla03') ? 'dia3' :
                     id.startsWith('charla02') ? 'dia2' : 'dia1';
        switchDay(day, true);
        ...
        // Switch day tab if needed
        const day = id.startsWith('charla03') ? 'día3' : id.startsWith('charla02') ? 'día2' : 'día1';
        switchDay(day, true);
    ...
    function switchDay(day, skipTalkSwitch) {
        ...
        document.querySelectorAll('.day-tab').forEach((tab, i) => {
            tab.classList.toggle('active', (day === 'día1' && i === 0) || (day === 'día2' && i === 1) || (day === 'día3' && i === 2));
        });
        ...
        if (!skipTalkSwitch) {
            const firstTalk = day === 'día1' ? 'charla01-1' : day === 'día2' ? 'charla02-1' : 'charla03-1';
            showTalk(firstTalk);
        }
    }
